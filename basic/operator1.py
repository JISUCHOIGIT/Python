...
print(int(s1) + 1) # 101 // int(s1) 형변환 후 계산
...
print("5,000원 : %d 장" % m50000)
print("1,000원 : %d 장" % m10000)
print("나머지 돈 : %d" % money)
...
# 논리연산자 : and, or, not
print(100 > 60 and 60 > 15) # True
print(100 > 60 or 60 > 15) # True // 자바 &&
print(100 > 60 or 60 < 15) # True // 자바 ||
print(not 60 < 15) # True
print(not False) # True
print(not True) # False // 자바 : print(!True)
